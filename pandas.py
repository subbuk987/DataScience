...
print("Series to list conversion:")
print(series_list)
...
base_array = np.array([0, 1, 2, 3, 4, 5, 6])
power_array = np.array([2, 3, 2, 3, 2, 3, 2])

result = np.power(base_array, power_array)
...
df = pd.DataFrame(exam_data, index=labels)
print("Selected 'name' and 'score' columns in rows 1, 3, 5, 6:")
...
df = pd.DataFrame(exam_data, index=labels)
print("Rows with attempts < 2 and score > 15:")
...
df = pd.DataFrame(exam_data, index=labels)
df.loc['d', 'score'] = 11.5
print("DataFrame after changing score in row 'd' to 11.5:")
print(df)
...
print(f"Sum of examination attempts: {total_attempts}")
...
print(f"Mean score for all students: {mean_score}")
...
print("DataFrame sorted by name (descending) and score (ascending):")
print(df_sorted)
...
print("DataFrame after replacing 'yes' and 'no' with True and False in 'qualify' column:")
print(df)
...
print("DataFrame after inserting a new column 'success':")
print(df)
...
df = pd.DataFrame(exam_data, index=labels)
print("Iterating over rows in DataFrame:")
